(() => {
    ...
    init() {
        ...
        this.audio.addEventListener('click', this.toggle);
        ...
        // loop control
        // const loopEle = this.element.getElementsByClassName('dplayer-loop-icon')[0];
